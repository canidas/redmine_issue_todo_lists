...
<b>Attention!</b> The plugin directory has been renamed from <tt>issue_todo_lists</tt> to <tt>redmine_issue_todo_lists</tt>. You have to rename plugin directory when updating!

== Compatibility

* Plugin is compatible with Redmine 2.6. Currently the plugin <b>doesn't work</b> with Redmine 3.
